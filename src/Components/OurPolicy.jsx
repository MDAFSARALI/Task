...
const OurPolicy = () => {
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-sm sm:text-sm md:text-base text-gray-700'>
      ...
      <div >
        <img src={assets.exchange_icon} alt="Exchange_Product" className='w-12 m-auto mb-5' />
      ...
      <div>
        <img src={assets.support_img} alt="Customer_Support" className='w-12 m-auto mb-5' />
